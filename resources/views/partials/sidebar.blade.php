                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ url('user') }}" class="nav-link active">
                                <i class="fa-solid fa-users" style="color: rgb(116, 192, 252);"></i>
                                <p class="ml-2">User</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('customer.index') }}" class="nav-link">
                                ...
                                <p class="ml-2">customer</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('products.index') }}" class="nav-link">
                                <i class="fa-solid fa-list" style="color: rgb(116, 192, 252);"></i>
                                <p class="ml-2">Product</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('category.index') }}" class="nav-link">
                                <i class="fa-solid fa-hashtag" style="color: rgb(116, 192, 252);"></i>
