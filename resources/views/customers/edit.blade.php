        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div>
                ...
                <small class="text-muted">
                    Update customer type information
                </small>
            </div>
            ...
            <div class="card-header bg-white border-bottom">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <small class="text-muted">
                            Modify the customer type details below
                        </small>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="customer_type_kh" id="customer_type_kh"
                                        ...
                                        value="{{ old('customer_type_kh', $customer->customer_type_kh) }}"
                                        placeholder="Enter customer type in Khmer">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="customer_type_en" id="customer_type_en"
                                        ...
                                        value="{{ old('customer_type_en', $customer->customer_type_en) }}"
                                        placeholder="Enter customer type in English">
